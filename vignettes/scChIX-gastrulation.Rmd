...
# Since this chunk requires you to download a large file, you can skip this and go directly to the scChIX output analysis, where you will just load the scChIX output
# data(CountMatsGastrulationInputs)  # this is >100 MB so download it from GEO because github doesn't allow large files
# Loading objects:
#   countmats.gastru
```
