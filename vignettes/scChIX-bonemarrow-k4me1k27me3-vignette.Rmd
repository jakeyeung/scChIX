---
title: "scChIX example: downstream of bone marrow"
output:
  md_document:
...
```{r load_objs_forfit_model_selection, echo=FALSE}
...
```{r visualize_one_cell, out.width="80%", echo=FALSE}
...
```{r visualize_all_cells, out.width="80%", echo=FALSE}
...
```{r deconvolve_matrix, echo=FALSE}
...
```{r project_cells_subset, echo=FALSE}
...
```{r plot_umap2, out.width="80%", echo = FALSE}
