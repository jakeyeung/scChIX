...
```{r init, out.width="80%", echo=FALSE}
...
```{r generate_counts, out.width="80%", echo=FALSE}
...
```{r check, out.width="80%", echo=FALSE}
...
```{r load_outputs, out.width="80%", echo=FALSE}
...
```{r umap, out.width="80%", echo=FALSE}
...
```{r hist, out.width="80%", echo=FALSE}
