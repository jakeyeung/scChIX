...
filtdir="filtered_count_tables_filtered_counts_varcutoffmin_0.03.noLSIfilt"
dname="TopBinsFilt"
...
indir="/hpc/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/${filtdir}/${dname}/${jmarkstr}"
