...
ldasuffix1="lda_outputs.countmat_var_filt.${mark1}.2021-07-15.K-30.binarize.FALSE/ldaOut.countmat_var_filt.${mark1}.2021-07-15.K-30.Robj"
ldasuffix2="lda_outputs.countmat_var_filt.${mark2}.2021-07-15.K-30.binarize.FALSE/ldaOut.countmat_var_filt.${mark2}.2021-07-15.K-30.Robj"
ldasuffix3="lda_outputs.countmat_var_filt.${markdbl}.2021-07-15.K-30.binarize.FALSE/ldaOut.countmat_var_filt.${markdbl}.2021-07-15.K-30.Robj"
