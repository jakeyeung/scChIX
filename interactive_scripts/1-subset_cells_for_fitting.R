...
load("/home/jyeung/projects/scChIX/data/TopBins_autosomesOnly.FewerTopics2_KeepAllPlates_clstrbytopics_K27m3xK9m3.removeNA_TRUE.RData", v=T)
rkeep <- rownames(count.dat$counts)
jsub <- count.mat.subset[rkeep, ]
count.mat.dbl.subset <- jsub

outf <- "/home/jyeung/projects/scChIX/data/ObjsForFittingSubset.tmp.RData"
save(count.mat.dbl.subset, dat.impute.repress.lst, dat.impute.active, file = outf)
