...
# File: ~/projects/scChIX/analysis_scripts/1-load_TES_mats_filter_good_cells.R
#
...
for (jmark in jmarks){
  print(jmark)
  outrds <- file.path(hubprefix, paste0("jyeung/data/dblchic/gastrulation/from_analysis/TES_filtered_count_tables_filtered_counts_varcutoffmin_0.03/TES_counts.", jmark, ".", Sys.Date(), ".rds"))
