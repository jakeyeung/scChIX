...
# File: ~/projects/scChIX/analysis_scripts/pseudotime/6-fit_pseudotime_K36.multicore.permute.R
#
...
outf <- file.path(outdir, paste0("glm_poisson_fits_output.permute.seed_", jseed, ".", jsuffix, ".", jmark, ".", Sys.Date(), ".RData"))
outpdf <- file.path(outdir, paste0("pseudotime_plots.permute.seed_", jseed, ".", jsuffix, ".", jmark, ".", Sys.Date(), ".pdf"))
...
save(jfits.lst, dat.annots.filt, ncuts.cells, count.mat.filt, dat.umap.filt, cnames.orig, cnames.permute, indx.permute, file = outf)
