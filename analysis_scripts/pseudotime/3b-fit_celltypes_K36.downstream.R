...
# File: ~/projects/scChIX/analysis_scripts/pseudotime/3b-fit_celltypes_K36.downstream.R
#
...
inf <- file.path(hubprefix, "jyeung/data/dblchic/gastrulation/from_analysis/glm_fits_outputs/by_clusters/manual2nocenter_K36_K9m3_K36-K9m3/glm_poisson_fits_output.clusters.manual2nocenter_K36_K9m3_K36-K9m3.K36.RData")
load(inf, v=T)
