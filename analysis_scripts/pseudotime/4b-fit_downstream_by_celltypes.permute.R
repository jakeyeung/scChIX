...
infs.fits <- lapply(jmarks, function(jmark){
  inf.tmp <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/glm_fits_outputs/by_clusters/manual2nocenterfilt2_K36_K9m3_K36-K9m3/glm_poisson_fits_output.clusters.manual2nocenterfilt2_K36_K9m3_K36-K9m3.", jmark, ".permute_seed_", jseed, ".RData")
...
outs.lst <- lapply(infs.fits, function(inf.tmp){
  load(inf.tmp, v=T)
  return(list(jfits.lst = jfits.lst, dat.annots.filt.mark = dat.annots.filt.mark, ncuts.cells.mark = ncuts.cells.mark, count.mat.permute = count.mat.permute, dat.ctype = dat.ctype))
})
...
qval.cutoff <- 10^-8
jmark.tmp <- "K9m3"
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/glm_fits_outputs/by_clusters/manual2nocenterfilt2_K36_K9m3_K36-K9m3.permute"
dir.create(outdir)
