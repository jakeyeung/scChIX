...
# File: ~/projects/scChIX/analysis_scripts/3e-remove_center_cells_manual2.K27.unify_K36.R
# Remove E8, keep K36 same as in K9 analysis
...
prefix.out <- "var_filtered_manual2nocenternoE8unifyK36"
