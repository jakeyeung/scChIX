...
# File: ~/projects/scChIX/analysis_scripts/4-analyze_scChIX_outputs_projections_cleaned_up2.R
#
...
metamain <- file.path(paste0("/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/rds_objs_celltyping_from_cleaned_LDA"), jsuffix)
assertthat::assert_that(dir.exists(metamain))

dat.meta.lst <- lapply(jmarks, function(jmark){
  infmeta <- file.path(metamain, paste0("celltyping_output_filt.", jmark, ".2021-07-10.rds"))
