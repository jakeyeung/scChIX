...
# outdir <- file.path(hubprefix, "jyeung/data/dblchic/simulation_data.all_mut_excl/snakemake_inputs/countmats")
outdir <- file.path(hubprefix, "jyeung/data/dblchic/simulation_data.all_common/snakemake_inputs/countmats")
...
ctype.params <- list(ctype.name = c("A", "B", "C"),
                     ...
                     frac.mutual.excl = c(0.01, 0.01, 0.01))
