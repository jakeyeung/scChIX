# Jake Yeung
# Date of Creation: 2021-07-08
# File: ~/projects/scChIX/analysis_scripts/4-analyze_scChIX_outputs_projections_cleaned_up.R
# Load projections and analyze outputs
...
infs <- lapply(jmarks, function(jmark){
    inf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/LDA_scchix_outputs/", jsuffix, "/Gastru_Unmixed_DblMark.", jsuffix, ".", jmark, ".RData")
...
metamain <- file.path(paste0("/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/rds_objs_celltyping_NN_15_check_plates"), jsuffix)
assertthat::assert_that(dir.exists(metamain))

dat.meta.lst <- lapply(jmarks, function(jmark){
  infmeta <- file.path(metamain, paste0("celltyping_output_filt.", jmark, ".2021-07-07.rds"))
...
infrdata <- file.path(hubprefix, paste0("jyeung/data/dblchic/gastrulation/scchix_pipeline/scchix_outputs.", jsuffix, "/unmix_scchix_inputs_clstr_by_celltype_K36-K9m3.removeNA_FALSE.RData"))
