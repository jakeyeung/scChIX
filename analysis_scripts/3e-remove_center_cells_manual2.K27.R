...
# File: ~/projects/scChIX/analysis_scripts/3e-remove_center_cells_manual2.K27.R
# Remove cells in center of K36
...
prefix.out <- "var_filtered_manual2nocenter"
...
bad.clsts.lst <- list(c("cluster1", "cluster11"), c(), c())
