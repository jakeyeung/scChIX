...
# File: ~/projects/scChIX/analysis_scripts/1-explore_raw_count_data_K9me3.R
...
outdir <- file.path(hubprefix, "jyeung/data/dblchic/gastrulation/from_analysis/filtered_count_tables")
