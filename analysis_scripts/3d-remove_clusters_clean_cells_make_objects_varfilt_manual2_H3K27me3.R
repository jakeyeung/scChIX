...
# bad louvs from dbl
bad.pairs.act <- c("cluster1", "cluster11")
...
# check size
inf.check <- "/home/jyeung/hub_oudenaarden/jyeung/data/dblchic/gastrulation/from_analysis/rds_objs_celltyping_from_less_stringent2/var_filtered_manual/K36_K27_K36-K27/countmat_var_filt.K36-K27.2021-07-19.rds"
