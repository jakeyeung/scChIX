...
# File: ~/projects/scChIX/analysis_scripts/2-check_LDA_outputs_cleaned.R
# description
rm(list=ls())
...
# jsuffix <- "50000"
# jdate <- "2021-07-07"
# jsuffix <- "50000_dbl_k36_k9m3_cleaned"
# jsuffix <- "50000_dbl_k36_cleaned"

jdate <- "2021-07-09"
jsuffix <- "50000_dbl_cleaned"

jmark <- jmarks[[1]]

infs <- lapply(jmarks, function(jmark){
  print(jmark)
  inf <- file.path(hubprefix, paste0("jyeung/data/dblchic/gastrulation/LDA_outputs/ldaAnalysis_", jsuffix, "/lda_outputs.countmat_output_filt.", jmark, ".", jdate, ".K-30.binarize.FALSE/ldaOut.countmat_output_filt.", jmark, ".", jdate, ".K-30.Robj"))
